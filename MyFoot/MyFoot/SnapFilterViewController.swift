...
class SnapFilterViewController: UIViewController {
    ...
    fileprivate let buttonSave = SNButton(frame: CGRect(x: 20, y: SNUtils.screenSize.height - 130, width: 33, height: 30), withImageNamed: "saveButton")
    fileprivate let buttonCamera = SNButton(frame: CGRect(x: 75, y: SNUtils.screenSize.height - 130, width: 45, height: 45), withImageNamed: "galleryButton")
    ...
    fileprivate func createData(_ image: UIImage) {
        ...
        self.data[1].addSticker(SNSticker(frame: CGRect(x: 195, y: 30, width: 90, height: 90), image: UIImage(named: "psg")!))
        self.data[2].addSticker(SNSticker(frame: CGRect(x: 30, y: 100, width: 250, height: 250), image: UIImage(named: "psg")!))
        self.data[3].addSticker(SNSticker(frame: CGRect(x: 20, y: 00, width: 140, height: 140), image: UIImage(named: "psg")!))
    }
...
extension SnapFilterViewController: SNSliderDataSource {
...
extension SnapFilterViewController: UIGestureRecognizerDelegate {
...
extension SnapFilterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
